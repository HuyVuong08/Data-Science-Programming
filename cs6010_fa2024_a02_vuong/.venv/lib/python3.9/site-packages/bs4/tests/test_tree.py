...
class TestFindAll(SoupTest):
    ...
    def test_find_all_with_self_referential_data_structure_does_not_cause_inftyite_recursion(self):
        soup = self.soup("<a></a>")
        # Create a self-referential list.
        l = []
        l.append(l)

        # Without special code in _normalize_search_value, this would cause inftyite
        # recursion.
